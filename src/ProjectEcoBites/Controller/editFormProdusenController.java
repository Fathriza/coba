...
public class editFormProdusenController implements Initializable {
    ...
    @FXML
    private void updateMakan(ActionEvent event) {
        for (int i = 0; i < produk.size(); i++) {
            Produk prod = produk.get(i);
            if (i == 0) {
                prod.setstok(Integer.parseInt(uploadStok.getText()));
                prod.setnama(uploadNama.getText());
                prod.setwaktu(uploadWaktu.getText());
                prod.setalamat(uploadAlamat.getText());
                prod.setdeskripsi(uploadDeskripsi.getText());
                // ...
                break;
            }
        }
        ...
        //                     prod.setwaktu(uploadWaktu.getText());
        //                     prod.setalamat(uploadAlamat.getText());
        //                     prod.setdeskripsi(uploadAlamat.getText());
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        for (int i =0 ;i <produk.size() ;i++){
           ...
           if (i == 0) {
               uploadNama.setText( pro.getnama());
               uploadAlamat.setText(pro.getalamat());
               uploadDeskripsi.setText( pro.getdeskripsi());
               uploadStok.setText(String.valueOf(pro.getstok()));
               uploadWaktu.setText(pro.getwaktu());
               }
